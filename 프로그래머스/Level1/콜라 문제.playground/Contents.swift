...
// 보유 중인 빈 병이 a개 미만이면, 추가적으로 빈 병을 받을 순 없습니다. 상빈이는 열심히 고심했지만, 일반화된 콜라 문제의 답을 찾을 수 없었습니다. 상빈이를 도와, 일반화된 콜라 문제를 해결하는 프로그램을 만들어 주세요.
...
func solution(_ a: Int, _ b: Int, _ n: Int) -> Int {
    ...
    while bottles >= a {
        let divided = bottles / a
        let mod = bottles % a
        exchangeCount += (divided * b)
        bottles = (divided * b) + mod
    }
